    ...
    <header className="bg-transparent absolute inset-x-0 top-0 z-50">
      ...
      >
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <img
              ...
              src="https://images.glints.com/unsafe/glints-dashboard.s3.amazonaws.com/company-logo/41b3a875fa22907ade8d0c153a002b90.png"
              alt="icon-header"
              loading="lazy"
            />
          </a>
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          ...
          <NavLink href="/gatcha">Gatcha</NavLink>
        </div>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <NavLink href="articles" className="-mx-3 block rounded-lg px-3 py-2">
                  Articles
                </NavLink>
                <NavLink href="history" className="-mx-3 block rounded-lg px-3 py-2">
                  History
                </NavLink>
                <NavLink href="gatcha" className="-mx-3 block rounded-lg px-3 py-2">
                  Gatcha
                </NavLink>
              </div>
            </div>
